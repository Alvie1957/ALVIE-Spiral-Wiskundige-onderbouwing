> **Attribution**: This document was generated by an AI assistant (DeepSeek) based on user prompts. It is provided as a reference and has not been independently verified in all details.
