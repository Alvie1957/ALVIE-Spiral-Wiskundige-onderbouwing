...
- The golden angle (137.5°) ensures optimal packing
...
if __name__ == "__main__":
    ...
    # Save to file
    with open("ALVIE_SPIRAL_PRINCIPLE_MANIFESTO.txt", "w", encoding="utf-8") as f:
        f.write(MANIFESTO)
    
    print("\n✅ Manifesto saved to: ALVIE_SPIRAL_PRINCIPLE_MANIFESTO.txt")
